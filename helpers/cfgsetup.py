...
# Using shell true is dangerous (is it necessary?)
unique_id = subprocess.check_output(
    r"sed -n 's/^Serial\s*: 0*//p' /proc/cpuinfo", shell=True)
configFileSSID = "electroLAB-Birdhouse-" + unique_id.strip().decode('utf-8')
...
#     print("Config file and hostapd passphrases match."
